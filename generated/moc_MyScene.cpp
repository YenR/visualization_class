...
QT_MOC_LITERAL(1, 8, 12), // "sceneChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16) // "sceneAxisChanged"

    },
    "MyScene\0sceneChanged\0\0sceneAxisChanged"
};
...
void MyScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sceneChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->sceneAxisChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyScene::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyScene::sceneChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (MyScene::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyScene::sceneAxisChanged)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MyScene::sceneChanged(int _t1, int _t2)
{
...
// SIGNAL 1
void MyScene::sceneAxisChanged(int _t1)
{
